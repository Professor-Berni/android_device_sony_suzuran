...
include $(CLEAR_VARS)
LOCAL_MODULE       := init.sony.cpu_parameter.sh
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/init.sony.cpu_parameter.sh
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := init.sony.cpu_parameter_gov.sh
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/init.sony.cpu_parameter_gov.sh
include $(BUILD_PREBUILT)
